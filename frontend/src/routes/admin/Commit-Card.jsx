...
const CommitCard = ({
	...
	//       `${backendUrl}/user/news/image-high?news_id=${NID}`
	//     );
	...
	//             `${backendUrl}/user/publication/image-low?publication_id=${relatedTopic.PID}`
	//           );
	//           setImgSmall(fetchedImg);
	//         } else if (relatedTopic.RID) {
	//           const fetchedImg = await getImgData(
	//             `${backendUrl}/user/research/image-low?research_id=${relatedTopic.RID}`
	//           );
	//           setImgSmall(fetchedImg);
	//         } else if (relatedTopic.LID) {
	//           const fetchedImg = await getImgData(
	//             `${backendUrl}/user/laboratory/image-low?laboratory_id=${relatedTopic.LID}`
	//           );
	//           setImgSmall(fetchedImg);
	//         }
	//       }
