...
export const editFrame = {
	...
	editLab: {
		...
		body: [{ image: 'file' }],
		url: `${backendUrl}/lead_researcher/laboratory`,
	},
	//ok
	editResearch: {
		type: 'patch',
		...
		url: `${backendUrl}/lead_researcher/research`,
	},
	//ok
	...
	assignToResearch: {
		...
		url: `${backendUrl}/lead_researcher/researcher`,
	},
	//ok
	assignAsLeadR: {
		type: 'patch',
		...
		url: `${backendUrl}/admin/researcher`,
	},
	//ok
	editPublication: {
		type: 'patch',
		...
		body: [{ image: 'file' }],
		url: `${backendUrl}/lead_researcher/publication`,
	},
};
...
export const createFrame = {
	...
	createLab: {
		...
		body: [{ image: 'file' }],
		url: `${backendUrl}/admin/laboratory`,
	},
	//ok
	createNews: {
		type: 'post',
		...
		url: `${backendUrl}/researcher/news`,
	},
	//ok
	createEvent: {
		type: 'post',
		...
		url: `${backendUrl}/researcher/event`,
	},
	//ok
	createResearch: {
		type: 'post',
...
export const submitFrame = {
	...
	submitEvent: {
		...
		url: `${backendUrl}/lead_researcher/event`,
	},
	submitNews: {
		type: 'patch',
		param: [{ news_id: 'text' }, { is_approved: 'checkbox' }],

		url: `${backendUrl}/lead_researcher/news`,
	},
};
