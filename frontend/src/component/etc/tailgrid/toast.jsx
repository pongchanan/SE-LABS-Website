...
export default function WarningToast({ info }) {
        ...
        <div className="flex justify-end">
          <div className="flex w-full max-w-[490px] items-center rounded-lg border border-[#F5C5BB] bg-[#FCEDEA] p-4">
            ...
            <div className="flex w-full items-center justify-between">
              ...
              <button
                className="ml-2 flex h-7 w-7 items-center justify-center rounded bg-white text-body-color hover:bg-[#EA4E2C] hover:text-white"
                onClick={() => dispatch(editAction.setIsSuccess([]))}
              >
                <svg
                  width="20"
                  height="20"
